...
public class Rectangle extends Shapes2D implements Rotateable{
	private Vertex2D p1, p2, p3;
	/**
	 ...
	 * @param y1
	 */
	public Rectangle(double x0, double y0, double x1, double y1, double x2, double y2,
			double x3, double y3){
		p0 = new Vertex2D(x0, y0);
		p1 = new Vertex2D(x1, y1);
		centre = this.calculateCentre();
		p2 = new Vertex2D(x2, y2);
		p3 = new Vertex2D(x3, y3);
	}
	/**
