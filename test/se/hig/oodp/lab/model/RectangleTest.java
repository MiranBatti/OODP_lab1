...
import se.hig.oodp.lab.model_2.Rectangle;
...
public class RectangleTest {
	...
	public void setUp() throws Exception {
		r = new Rectangle(-1, 3, 5, -1, -1, -1, 5, 3);
	}
	...
	public void testVertexPositions() {
		...
		assertEquals("Wrong position4", -1, r.getP1().getY(), 0.0001);
		//P3
		assertEquals("Wrong position5", 5, r.getP3().getX(), 0.0001);
		assertEquals("Wrong position6", 3, r.getP3().getY(), 0.0001);
		//P0
	...
	public void testScale(){
		...
		assertEquals("Wrong position", -1.42, r.getP1().getY(), 0.0001);
		//P2
		assertEquals("Wrong position", 5.63, r.getP3().getX(), 0.0001);
		assertEquals("Wrong position", 3.42, r.getP3().getY(), 0.0001);
		//P0
